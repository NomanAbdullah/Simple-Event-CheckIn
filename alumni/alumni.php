	...
	<div class="container-fluid">
		<div class="row justify-content-center">
			<div class="col-md-10 bg-light mt-2 rounded pb-3">
				<h1 align="center" class="text-primary p-2"><strong>I N I T 5 Check In | Alumni</strong>
				</h1>
				<hr>
				<div class="form-inline">
					<label for="Search" class="front-weight-bold lead text-dark">Search Record</label>&nbsp;&nbsp;&nbsp;&nbsp;
					<input type="text" name="search" id="search_text" class="form-control form-control-1g rounded-0 border-primary" placeholder="Enter RegNo or Contact">
				</div>
				<hr>
				<?php 
					include 'config.php';
					$stmt=$conn->prepare("SELECT * FROM tbl_alumni");
					$stmt->execute();
					...
					<tbody>
						<?php while($row=$result->fetch_assoc()){ ?>
							...
							<tr>
								...
								<td><?= $row['Batch']; ?></td>
								<td>
									<a href="setAlumniStatus.php?id=<?php echo $RegNo; ?>">
										<?php if($Status == "Yes"){ ?>
